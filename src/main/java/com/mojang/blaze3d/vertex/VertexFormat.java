...
import net.caffeinemc.sodium.api.vertex.format.VertexFormatRegistry;
...
public class VertexFormat {
    ...
    // Sodium
    @Getter private int globalId;

    VertexFormat(List<VertexFormatElement> elements,
                 List<String> names,
                 IntList offsets,
                 int vertexSize) {
        ...
        this.elementsMask = elements.stream().mapToInt(VertexFormatElement::mask).reduce(0, (p_344142_, p_345074_) -> p_344142_ | p_345074_);
        ...
        // Sodium
        this.globalId = VertexFormatRegistry.instance().allocateGlobalId(this);
    }
