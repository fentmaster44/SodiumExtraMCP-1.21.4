...
import net.caffeinemc.sodium.client.gui.options.*;
import net.caffeinemc.sodium.client.gui.options.binding.compat.VanillaBooleanOptionBinding;
...
import net.caffeinemc.sodium.client.gui.options.storage.SodiumOptionsStorage;
...
public class SodiumGameOptionPages {
    ...
    public static OptionPage general() {
        ...
        groups.add(OptionGroup.createBuilder()
                ...
                .add(OptionImpl.createBuilder(int.class, vanillaOpts)
                        ...
                        .build())
                // SodiumExtra
                .add(OptionImpl.createBuilder(SodiumExtraGameOptions.VerticalSyncOption.class, SodiumExtraGameOptionPages.sodiumExtraOpts)
    ...
    public static OptionPage quality() {
        val groups = new ArrayList<OptionGroup>();
