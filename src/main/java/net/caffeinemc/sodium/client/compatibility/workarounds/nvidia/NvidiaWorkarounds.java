package net.caffeinemc.sodium.client.compatibility.workarounds.nvidia;
...
import net.caffeinemc.sodium.client.compatibility.environment.OsUtils.OperatingSystem;
import net.caffeinemc.sodium.client.compatibility.environment.probe.GraphicsAdapterProbe;
import net.caffeinemc.sodium.client.compatibility.environment.probe.GraphicsAdapterVendor;
import net.caffeinemc.sodium.client.compatibility.workarounds.Workarounds;
import net.caffeinemc.sodium.client.platform.unix.Libc;
import net.caffeinemc.sodium.client.platform.windows.WindowsCommandLine;
import net.caffeinemc.sodium.client.platform.windows.WindowsFileVersion;
import net.caffeinemc.sodium.client.platform.windows.api.d3dkmt.D3DKMT;
