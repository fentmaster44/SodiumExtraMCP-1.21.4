...
import net.caffeinemc.sodium.client.render.chunk.occlusion.GraphDirectionSet;
import net.caffeinemc.sodium.client.render.chunk.occlusion.VisibilityEncoding;
