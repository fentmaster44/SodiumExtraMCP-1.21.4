package net.caffeinemc.sodium.client.render;
...
import net.caffeinemc.sodium.client.render.chunk.RenderSectionManager;
...
import net.caffeinemc.sodium.client.render.chunk.map.ChunkTrackerHolder;
...
import net.caffeinemc.sodium.client.util.LocalBooleanRef;
import net.caffeinemc.sodium.client.util.NativeBuffer;
import net.caffeinemc.sodium.client.world.LevelRendererExtension;
...
public class SodiumWorldRenderer {
    ...
    private void initRenderer(CommandList commandList) {
        ...
        var tracker = this.level.getChunkTracker();
    ...
    public <T extends Entity, S extends EntityRenderState> boolean isEntityVisible(EntityRenderer<T, S> renderer, T entity) {
        ...
        AABB bb = renderer.getCullingBox(entity);
