package net.caffeinemc.sodium.client.render.vertex.serializers.generated;
...
public class VertexSerializerFactory {
    ...
    public static Bytecode generate(VertexFormat srcFormat, VertexFormat dstFormat, String identifier) {
        ...
        var name = "net/caffeinemc/sodium/client/render/vertex/serializers/generated/VertexSerializer$Impl$" + identifier;
