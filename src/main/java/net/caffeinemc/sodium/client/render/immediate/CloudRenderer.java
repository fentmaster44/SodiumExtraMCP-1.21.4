package net.caffeinemc.sodium.client.render.immediate;
...
public class CloudRenderer {
    ...
    private static int getCloudRenderDistance() {
        return Math.max(32, (Minecraft.getInstance().options.getEffectiveRenderDistance() * (SodiumExtraClientMod.options().extraSettings.cloudDistance / 100) * 2) + 9);
    }
