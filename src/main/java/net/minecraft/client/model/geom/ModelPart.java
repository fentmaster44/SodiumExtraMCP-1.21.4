...
import net.caffeinemc.sodium.client.render.immediate.model.EntityRenderer;
import net.caffeinemc.sodium.client.render.immediate.model.ModelCuboid;
...
public final class ModelPart {
    ...
    public static class Cube {
        ...
        public Cube(
            ...
            this.maxY = y + sizeY;
            this.maxZ = z + sizeZ;
            this.polygons = new ModelPart.Polygon[renderDirections.size()];
            float f = x + sizeX;
            float f1 = y + sizeY;
            float f2 = z + sizeZ;
            x -= extraX;
