...
public class SkyRenderer implements AutoCloseable {
    ...
    private void renderSun(float f,
    ...
    private void renderMoon(int p_367893_,
                            float f,
                            MultiBufferSource multiBufferSource,
                            PoseStack poseStack) {
        // SodiumExtra
    ...
    private void renderStars(FogParameters fogParameters,
                             float f,
                             PoseStack poseStack) {
        // SodiumExtra
    ...
    public void renderSunriseAndSunset(PoseStack poseStack,
        ...
        float f = Mth.sin(v) < 0.0F ? 180.0F : 0.0F;
        ...
        float f1 = ARGB.alphaFloat(i1);
        vertexconsumer.addVertex(matrix4f, 0.0F, 100.0F, 0.0F).setColor(i1);
        int i = ARGB.transparent(i1);
