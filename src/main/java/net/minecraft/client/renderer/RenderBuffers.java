...
import net.caffeinemc.sodium.client.render.chunk.NonStoringBuilderPool;
...
public class RenderBuffers {
    ...
    public RenderBuffers(int p_312933_) {
        // Sodium - use NonStoringBuilderPool
        ...
        SequencedMap<RenderType, ByteBufferBuilder> sequencedmap = Util.make(new Object2ObjectLinkedOpenHashMap<>(), p_357875_ -> {
            ...
            put(p_357875_, RenderType.armorEntityGlint());
            put(p_357875_, RenderType.glint());
            put(p_357875_, RenderType.glintTranslucent());
            put(p_357875_, RenderType.entityGlint());
            put(p_357875_, RenderType.waterMask());
        });
        ...
        SequencedMap<RenderType, ByteBufferBuilder> sequencedmap1 = Util.make(
            ...
            p_357874_ -> ModelBakery.DESTROY_TYPES
                    .forEach(p_173062_ -> put(p_357874_, p_173062_))
        );
