...
public class GuiGraphics {
    ...
    public void fill(RenderType p_286602_,
                     int p_286738_,
                     int p_286614_,
                     int p_286741_,
                     int p_286610_,
    ...
    // SodiumExtra
    public void fill(RenderType type,
                     int x1,
                     int y1,
                     int x2,
                     int y2,
        ...
        val vertexConsumer = this.bufferSource.getBuffer(type);
        val writer = VertexBufferWriter.of(vertexConsumer);
        color = ColorARGB.toABGR(color);

        try (val stack = MemoryStack.stackPush()) {
            val buffer = stack.nmalloc(4 * ColorVertex.STRIDE);
            long ptr = buffer;
...
//        vertexconsumer.addVertex(matrix4f, (float)x1, (float)y1, (float)z).setColor(color);
//        vertexconsumer.addVertex(matrix4f, (float)x1, (float)y2, (float)z).setColor(color);
//        vertexconsumer.addVertex(matrix4f, (float)x2, (float)y2, (float)z).setColor(color);
//        vertexconsumer.addVertex(matrix4f, (float)x2, (float)y1, (float)z).setColor(color);
    }
    ...
    private void fillGradient(VertexConsumer vertexConsumer,
                              int startX,
                              int startY,
                              int endX,
                              int endY,
...
//        vertexConsumer.addVertex(matrix4f, (float)startX, (float)startY, (float)z).setColor(colorStart);
//        vertexConsumer.addVertex(matrix4f, (float)startX, (float)endY, (float)z).setColor(colorEnd);
//        vertexConsumer.addVertex(matrix4f, (float)endX, (float)endY, (float)z).setColor(colorEnd);
//        vertexConsumer.addVertex(matrix4f, (float)endX, (float)startY, (float)z).setColor(colorStart);
        // SodiumExtra
        val writer = VertexBufferWriter.of(vertexConsumer);
        val matrix4f = this.pose.last().pose();
    ...
    public void blitSprite(Function<ResourceLocation, RenderType> renderTypeGetter,
    ...
    private void blitSprite(Function<ResourceLocation, RenderType> renderTypeGetter,
                            TextureAtlasSprite sprite,
                            int textureWidth,
                            int textureHeight,
                            int uPosition,
    ...
    // SodiumExtra
    private void innerBlit(Function<ResourceLocation, RenderType> function,
        ...
        // FIXME
//        val renderType = function.apply(resourceLocation);
//        val matrix4f = this.pose.last().pose();
...
//
//        try (val stack = MemoryStack.stackPush()) {
//            val buffer = stack.nmalloc(4 * TextureVertex.STRIDE);
//            long ptr = buffer;
//
