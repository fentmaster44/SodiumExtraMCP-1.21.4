    ...
    public static class Starter extends NoRenderParticle {
        ...
        public void tick() {
            ...
            if (this.life % 2 == 0 && this.life / 2 < this.explosions.size()) {
                ...
                val particle = this.engine.createParticle(ParticleTypes.FLASH, this.x, this.y, this.z, 0.0, 0.0, 0.0);
        ...
        private void createParticle(double x,
                                    double y,
                                    double z,
                                    double velocityX,
                                    double velocityY,
            ...
            FireworkParticles.SparkParticle fireworkparticles$sparkparticle = (FireworkParticles.SparkParticle)this.engine
                .createParticle(ParticleTypes.FIREWORK, x, y, z, velocityX, velocityY, velocityZ);
            fireworkparticles$sparkparticle.setTrail(trail);
            fireworkparticles$sparkparticle.setTwinkle(flicker);
            fireworkparticles$sparkparticle.setAlpha(0.99F);
            fireworkparticles$sparkparticle.setColor(Util.getRandom(colors, this.random));
            if (!targetColors.isEmpty()) {
                fireworkparticles$sparkparticle.setFadeColor(Util.getRandom(targetColors, this.random));
            }
        }
